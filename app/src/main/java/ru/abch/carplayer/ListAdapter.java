...
public class ListAdapter extends BaseAdapter {
    ...
    Context m_context;
    Boolean m_isRoot;
//    String TAG = "SPPlayer ListAdapter";
    ...
    private int setFileImageType(File m_file)
    {
        ...
        if (m_file.isDirectory())
            return R.drawable.filetype_dir;
        else
        {
            ...
            else if(m_lastIndex > 0 && m_filepath.substring(m_lastIndex).equalsIgnoreCase(".jpg"))
            {
                return R.drawable.filetype_image;
            }
            else
            {
