...
public class PlayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        m_RootList = view.findViewById(R.id.pl_lvListRoot);
        playList = MainActivity.pList.get();
        Log.d(TAG, "Music root = " + musicRoot + " " + playList.size() + " tracks");
        playListAdapter = new PlayListAdapter(getActivity(), playList);
        m_RootList.setAdapter(playListAdapter);
        Log.d(TAG, "List view size = " + m_RootList.getCount());
        return view;
    }
